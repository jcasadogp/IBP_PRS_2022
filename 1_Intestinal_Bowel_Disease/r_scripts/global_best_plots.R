...
# When LDpred works change here only the name of the df ==> remove best_target.lasso and put best_target.ldpred
#need to write table for best prs
write.table(best_target.lasso, snakemake@output[[4]], col.names = TRUE, row.names = FALSE, quote = FALSE)
